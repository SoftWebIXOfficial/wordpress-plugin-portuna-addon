...
(function () {
  ...
  (function ($, window) {
    var megaMenuHorizontal = {
      ...
      megaMenuHorizontalOptions: function megaMenuHorizontalOptions($scope) {
        var wrap = $($scope[0]);
        wrap.find('.portuna-addon-sub-mega-menu');
        ...
        $(window).on('resize orientationchange', debounce_1(controlMegaMenuWidth, 100));
      }
    };
