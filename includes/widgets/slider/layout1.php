...
$this->add_render_attribute( 'wrapper', 'class', 'portuna-addon--slider--layout1' );
            ...
            <div class="swiper-wrapper">
                <?php foreach ( $items as $key => $item ) : ?>
                    <div class="swiper-slide">
                        <?php echo \PortunaAddon\Helpers\Utils::parse_widget_content( $portuna_slides_elementor, $this->get_id(), $key ); ?>
                    </div>
                <?php endforeach; ?>
            </div>
