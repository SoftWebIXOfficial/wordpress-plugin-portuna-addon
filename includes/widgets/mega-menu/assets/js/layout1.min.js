    ...
    var megaMenuExtensions = function megaMenuExtensions($scope) {
      ...
      self.subMenuControlWidth = function () {
        ...
        subMenus.each(function () {
          $(this).closest('.portuna-addon-menu-item').offset().left;
          $(this).width(windowWidth);
        });
      };

      self.megaMenuControlBreakpoint = function () {
        var wrapClass = $scope.find('.portuna-addon--mega-menu--layout1');
        var breakpointEnabled = $scope.find('.portuna-addon--mega-menu--layout1-breakpoint--yes');

        if (breakpointEnabled) {
          $('body').outerWidth(true);
          var windowWidth = $(window).outerWidth(true);
          var scopeClasses = ($scope.attr('class') || '').split(' ');

          for (var i = 0, len = scopeClasses.length; i < len; i++) {
            switch (scopeClasses[i]) {
              ...
              case 'portuna-addon-menu-breakpoint--custom':
                var scopeObjStyle = window.getComputedStyle($scope[0]),
      ...
      self.megaMenuControlResponsibility = function () {
        var menuOpen = $scope.find('.portuna-addon--mega-menu--toggle.open-menu'),
