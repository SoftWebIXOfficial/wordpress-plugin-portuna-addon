...
<div class="dialog-widget dialog-lightbox-widget dialog-type-buttons dialog-type-lightbox elementor-templates-modal portuna-addon-widgets-content-modal" id="elementor-template-widgetarea-modal-container" style="display: none;">
			...
			<div class="elementor-templates-modal__header">
				<div class="elementor-templates-modal__header__logo-area">
					<div class="elementor-templates-modal__header__logo">
						...
						<span class="elementor-templates-modal__header__logo__title">
						    <?php esc_html_e( 'Portuna Addon Widget Area', 'portuna-addon' ); ?>
                        </span>
					</div>
				</div>
				...
				<div class="elementor-templates-modal__header__items-area">
					<div class="elementor-templates-modal__header__close elementor-templates-modal__header__close--normal elementor-templates-modal__header__item">
						<i class="eicon-close" aria-hidden="true" title="<?php echo esc_attr__( 'Close', 'portuna-addon' ); ?>"></i>
				...
				<div id="elementor-template-library-loading">
					<div class="elementor-loader-wrapper">
						...
						<div class="elementor-loading-title">
						    <?php esc_html_e( 'Loading', 'portuna-addon' ); ?>
                        </div>
					</div>
				</div>
			</div>
